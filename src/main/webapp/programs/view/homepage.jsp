                		  ...
                		  <%
	                		  ...
	                		  String url = "jdbc:mysql://localhost:3306/WebPage";
               					try{
               						...
               						PreparedStatement stmt2=conn.prepareStatement("Select * from  email where reciver = ?  and  email_id not in(select email_id from trash where email = ? )" );
            						 ...
            						 stmt2.setString(2, email);
               					    ...
               					    while(rs.next()){
   					    			 	 ...
   					    			 	 out.println("<tr><td><a href='#'  >"  +sender+"</a></td> ");
           					    	  	 out.println("<td class='subject'><a href='message.jsp?id="+id+" '>"+ subject+" </a></td></tr>");
               					    }
               					    conn.close();
